        ...
        {featuredCard.map((value, index) => {
          return (
            <div key={index} className="lg:w-3/12 sm:w-4/12 w-6/12 px-3 py-3">
              <div
                className="bg-white hover:shadow-[0px_11px_24px_0px_#0000001A] transition-all ease-in-out duration-[0.3s] w-full min-h-[120px] flex items-center justify-center px-3 py-4 h-full max-w-[210px] max-h-[120px] relative z-10"
